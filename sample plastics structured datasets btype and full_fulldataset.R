...
#vidal dataset can only be used in "broad" type analyses, as chemical ID is not sufficient to consider full material types
...
data_titles <- c("Plankton","Sediment", "Animal tissue","Animal tissue", "Sediment", "Animal tissue", "Animal tissue","Storm water")
databtype_titles <- c("Plankton","Sediment", "Animal tissue","Animal tissue", "Sediment", "Animal tissue", "Animal tissue","Storm water","Sediment")
...
write.csv(round(DescStats,digits=4),"~/Sample-microplastics/descriptive stats_narrow_manyjars.csv",row.names=F)
...
save(Rand_str_dp_narrow,file="~/Sample-microplastics/Rand_str_dp_narrow.Rdata")
...
save(Shp_str_dp_narrow,file="~/Sample-microplastics/Shp_str_dp_narrow.Rdata")
...
save(Col_str_dp_narrow,file="~/Sample-microplastics/Col_str_dp_narrow.Rdata")
...
save(ShpCol_str_dp_narrow,file="~/Sample-microplastics/ShpCol_str_dp_narrow.Rdata")
...
save(Rand_str_pool_narrow,file="~/Sample-microplastics/Rand_str_pool_narrow.Rdata")
...
save(Shp_str_pool_narrow,file="~/Sample-microplastics/Shp_str_pool_narrow.Rdata")
...
save(Col_str_pool_narrow,file="~/Sample-microplastics/Col_str_pool_narrow.Rdata")
...
save(ShpCol_str_pool_narrow,file="~/Sample-microplastics/ShpCol_str_pool_narrow.Rdata")
...
save(Rand_str_dp_b,file="~/Sample-microplastics/Rand_str_dp_b.Rdata")
...
save(Shp_str_dp_b,file="~/Sample-microplastics/Shp_str_dp_b.Rdata")
...
save(Col_str_dp_b,file="~/Sample-microplastics/Col_str_dp_b.Rdata")
...
save(ShpCol_str_dp_b,file="~/Sample-microplastics/ShpCol_str_dp_b.Rdata")
###Subsampling from the pool of particles from all samples in the dataset
...
save(Rand_str_pool_b,file="~/Sample-microplastics/Rand_str_pool_b.Rdata")
...
save(Shp_str_pool_b,file="~/Sample-microplastics/Shp_str_pool_b.Rdata")
...
save(Col_str_pool_b,file="~/Sample-microplastics/Col_str_pool_b.Rdata")
...
save(ShpCol_str_pool_b,file="~/Sample-microplastics/ShpCol_str_pool_b.Rdata")
...
write.csv(minimumsNSerr,"~/Sample-microplastics/minimums_SummedStrErrorLessThan20_narrow_manyjarsEqual.csv",row.names=F)
...
write.csv(minimumsSerr,"~/Sample-microplastics/minimums_SummedStrErrorLessThan20_broad_manyjarsEqual.csv",row.names=F)
...
write.csv(minimumsNpool,"~/Sample-microplastics/minimums_SummedErrorLessThan20_narrow_manyjarsPool.csv",row.names=F)
##BROAD characterization of material types
...
write.csv(minimumsBpool,"~/Sample-microplastics/minimums_SummedErrorLessThan20_broad_manyjarsPool.csv",row.names=F)
...
write.csv(minimumsR,"~/Sample-microplastics/minimums_EstSammpleRichnessGreaterThan80_narrow_manyjarsEqual.csv",row.names=F)
...
write.csv(minimumsRP,"~/Sample-microplastics/minimums_EstSammpleRichnessGreaterThan80_narrow_manyjarsPool.csv",row.names=F)
...
write.csv(minimumsAE,"~/Sample-microplastics/minimums_EstEnvRichnessgreaterthan80_narrow_manyjarsEqual.csv",row.names=F)
###subsampling from pooled samples
...
write.csv(minimumsAEP,"~/Sample-microplastics/minimums_EstEnvRichnessgreaterthan80_narrow_manyjarsPool.csv",row.names=F)
...
write.csv(minimumsC,"~/Sample-microplastics/minimums_EstEnvCoverageGreaterThan80_narrow_manyjarsEqual.csv",row.names=F)
##
...
write.csv(minimumsCP,"~/Sample-microplastics/minimums_EstEnvCoverageGreaterThan80_narrow_manyjarsPool.csv",row.names=F)
...
pdf("~/Sample-microplastics/SummedStrError_narrow_manyjarsEqual_3panel.pdf",height=3,width=6)
...
plot(1~1, pch=NA, xlim=c(0,nrows[i]),ylim=c(0,1),ylab="",xlab="",yaxt="n")
	...
	mtext(data_titles[i], side=3, line =0.25, cex=1)
 	if(i==4){axis(side=2)}
	if(i==4){mtext("Summed error",line=2.5,side=2)}#structured
	if(i==8){legend(150,y=0.65,c("20%Error"),lty=2,bty="n")}
	if(i==8){legend(150,y=1,c("Rand","Col","Morph","MorphCol"),fill=c(rgb(0,0,0),rgb(1,0,0),rgb(0,0,1),rgb(1,0,1)),bty="n")}
	if(i==2){mtext("Particles chemically identified",line=2.5,side=1)}
}
dev.off()
pdf("~/Sample-microplastics/SummedStrError_broad_manyjarsEqual_3panel.pdf",height=3,width=6)
layout(matrix(1:3,ncol=3,byrow=T))
par(oma=c(1,4,1,2))
par(mar=c(3,0,2,0))
for(i in c(4,2,8)){
...
dev.off()
##Full panels for summed structured error when subsampling equally from many samples in a set of samples are in supplement
#see "sample plastics grouped figures.R"
